...
> **Q**. Call the summary() function on your results to get a sense of
...
```
    ...
    Info: Working in directory /Users/christeenapano/BIMM 143/bimm143_github/class14
...
Cycle. KEGG and reactome analysis show that the cell cycle is the most
significantly downregulated and upregulated pathway, confirming this.
However, the factors that could cause the differences between the two
methods could be caused due to the differing contents of each database
and their methods of generating pathways independently. These databases
use different algorithims and calculate significance in different ways.
This is why using different tools is important for complete and accurate
analysis.
