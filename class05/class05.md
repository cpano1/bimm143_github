...
we can use the function `install.packages("ggplot2")` The main function
in the ggplot2 package is called `ggplot()`
...
> everytime we render our report
...
- the **geom** layer (how you want the plot draw, e.g. points, lines,
  etc.)
...
> Q. Howe many different “country” entries are in this dataset?
...
> Q. Make a histogram of lifeExp facetd by continent (try using
> `fill=continent` or `col=continent`)

> Q. Make a histogram of lifeExp facetd by continent
